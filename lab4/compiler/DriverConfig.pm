...
our $GCC            = "/usr/local/bin/gcc-4.8 -m64";     # gcc executable and default flags
...
my $TESTS1_MIN = 223;   # number of error cases in tests1
my $TESTS2_MIN = 1239;   # number of error cases in tests2
